...
I built this while working on a web app where I was using [Nested CSS](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_nesting) inside <style> tags. It worked fine at first, but I later realized it only works in modern browsers and completely breaks on older ones.
